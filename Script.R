...
plot_3 <- df_plotly_3 %>%
  ...
  add_trace(x = ~months[df_plotly_3$tdt_type_detail == "return" & df_plotly_3$but_idr_business_unit == "Evere"],
            ...
            type = "scatter", mode = "lines+markers", name = "Return Turnover", color = I("darkred"), visible = F) %>%
  add_trace(x = ~months[df_plotly_3$tdt_type_detail == "sale" &  df_plotly_3$but_idr_business_unit == "Liège"], 
            y = ~total_turnover_month_store[df_plotly_3$tdt_type_detail == "sale" & df_plotly_3$but_idr_business_unit == "Liège"],
            type = "scatter", mode = "lines+markers", name = "Sales Turnover", color = I("darkgreen"), visible = F) %>%
  add_trace(x = ~months[df_plotly_3$tdt_type_detail == "return" & df_plotly_3$but_idr_business_unit == "Liège"],
            y = ~total_turnover_month_store[df_plotly_3$tdt_type_detail == "return" & df_plotly_3$but_idr_business_unit == "Liège"],
            type = "scatter", mode = "lines+markers", name = "Return Turnover", color = I("darkred"), visible = F) %>%
